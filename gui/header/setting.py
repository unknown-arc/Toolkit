...
class SettingsButton(QPushButton):
    ...
    def _load_and_prepare_image(self):
        ...
        asset_path = r'Z:\Project\Toolkit\assests\setting_icon.png'
        ...
        if not image_loaded:
            ...
            print(f"SettingsButton: Could not load image at {asset_path}. Using GRAY fallback.")
...
if __name__ == '__main__':
    ...
    print(f"To test image success, manually place a file named '{SettingsButton.ASSET_FILENAME}'")
    print(f"in your 'Toolkit/assest' directory and run main.py.")
    
    # Use QWidget as the container for this simple demo
    main_window = QWidget() 
    button = SettingsButton(preferred_size=40)
